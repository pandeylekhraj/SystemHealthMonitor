...
def disk_Utilization():
    ...
    client.odb_set("/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/lastRead",timeoutput,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/MaxDiskSpceChk%",max_usage,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/MinDiskSpaceChk%",min_usage,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/nmDiskSpaceChk",num_of_partitions,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/nmGtrThreshold",higher_than_threshold,create_if_needed=True)
...
def processors_Utilization():
    ...
    client.odb_set("/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/lastRead",timeoutput,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/nmCPUChk",len(dfProc1["CPU"])-1,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/minCPUchk%",min(dfProc1['%utilize']),create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/maxCPUchk%",max(dfProc1['%utilize']),create_if_needed=True)
...
def memory_Utilization():
    ...
    #creating ODB keys and respective values in order to keep in webpage
    client.odb_set("/HealthMonitoring/"+hostoutput+"/MemoryUtilization/lastRead",timeoutput,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/MemoryUtilization/MemChk%",MemUtilization,create_if_needed=True)
    client.odb_set("/HealthMonitoring/"+hostoutput+"/MemoryUtilization/TotMemChkWtSwap%",TotUtilization,create_if_needed=True)
