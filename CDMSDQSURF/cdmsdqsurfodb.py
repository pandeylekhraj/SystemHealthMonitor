...
#os.system('scp cdms@192.168.28.12:/home/cdms/healthmonitoring/lekhraj/cdms-dqsurf.json /home/cdms/health_monitoring/lekhraj/SystemHealthMonitor/CDMSDQSURF/')
...
#/home/cdms/health_monitoring/lekhraj/SystemHealthMonitor/CDMSDQSURF
dir_list = os.listdir("/home/cdms/health_monitoring/lekhraj/SystemHealthMonitor/CDMSDQSURF/")
#print(dir_list)
json_dirs = []
for dir in dir_list:
...
list_keys=list(set((load_inf[0].keys())))
...
for i in range(len(load_inf)):
    ...
    for element in list_keys:
        ...
        client.odb_set("/HealthMonitoring/"+str(load_inf[i]['hostname'])+"/"+str(element),content1)
