...
def disk_Utilization():
    ...
    #creates ODB Keys lastread and keeps values timeoutput
    dqm.daq.midas.create_and_set_value(timeoutput,"/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/lastRead", 12)
    #creates ODB Keys MaxDiskSpceChk%  and keeps values max_usage which is integer
    dqm.daq.midas.create_and_set_value(max_usage,"/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/MaxDiskSpceChk%", 7)

    dqm.daq.midas.create_and_set_value(min_usage,"/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/MinDiskSpaceChk%",7 )
    ##creates ODB Keys nmDiskSpaceChk  and keeps values num_of_partitions which is float
    dqm.daq.midas.create_and_set_value(num_of_partitions,"/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/nmDiskSpaceChk",9)

    dqm.daq.midas.create_and_set_value(higher_than_threshold,"/HealthMonitoring/"+hostoutput+"/DiskSpaceUtilization/nmGtrThreshold", 9)
...
def processors_Utilization():
    ...
    dqm.daq.midas.create_and_set_value(timeoutput,"/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/lastRead", 12)
    dqm.daq.midas.create_and_set_value(len(dfProc1["CPU"])-1,"/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/nmCPUChk", 7)
    dqm.daq.midas.create_and_set_value(min(dfProc1['%utilize']),"/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/minCPUchk%",9)
    dqm.daq.midas.create_and_set_value(max(dfProc1['%utilize']),"/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/maxCPUchk%",9)
...
def memory_Utilization():
    ...
    #creating ODB keys and respective values in order to keep in webpage
    dqm.daq.midas.create_and_set_value(timeoutput,"/HealthMonitoring/"+hostoutput+"/MemoryUtilization/lastRead", 12)
    dqm.daq.midas.create_and_set_value(MemUtilization,"/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/memChk%",9)
    dqm.daq.midas.create_and_set_value(TotUtilization,"/HealthMonitoring/"+hostoutput+"/ProcessorsUtilization/TotMemChkWtSwap%",9)
