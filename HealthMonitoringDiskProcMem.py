...
#client.odb_set("/HealthMonitoring/ThresholdControl/"+hostoutput,content)
DiskSpaceThreshold=client.odb_get('/HealthMonitoring/ThresholdControl/'+hostoutput+'/NumDiskaboveTest_Value')
MeanProcessorThreshold=client.odb_get('/HealthMonitoring/ThresholdControl/'+hostoutput+'/MeanCPUutilThreshold')
MemThreshold=client.odb_get('/HealthMonitoring/ThresholdControl/'+hostoutput+'/MemUtilThreshold')
ODB_test = client.odb_get('/HealthMonitoring/ThresholdControl/'+hostoutput+'/ODB_Test_Value' )
